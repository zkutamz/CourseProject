...
const GetHelpInstructorAPI = () => axiosClient.get('/Helps/1');
const GetHelpStudentAPI = () => axiosClient.get('/Helps/2');

export { GetHelpInstructorAPI, GetFaQAPI, GetHelpSearchAPI, GetHelpStudentAPI };
